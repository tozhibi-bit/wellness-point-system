...
const updateSchema = z.object({
  ...
  photo1Url: z.string().url().max(2000).optional().or(z.literal("")),
  photo2Url: z.string().url().max(2000).optional().or(z.literal("")),
  accessNote: z.string().max(200).optional().nullable(),
  mapsUrl: z.string().url().max(2000).optional().or(z.literal("")),
